    ...
    <div class="row g-3 mb-3">
      <div class="col-12 col-sm-6 col-xl-3">
        <div class="info-box shadow-xs mb-0 h-100 bg-body">
          ...
          <div class="info-box-content">
            <span class="info-box-text text-secondary">TOTAL FISIK ON-HAND</span>
            <span class="info-box-number text-body fs-4 font-monospace">{{ totalOnHand.toLocaleString('id-ID') }} <span class="fs-8 fw-normal text-secondary">Unit</span></span>
            <div class="progress" style="height: 2px;">
              <div class="progress-bar bg-danger" style="width: 100%"></div>
            </div>
            <span class="progress-description fs-9 text-secondary">Stok Fisik di Lokasi</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-xl-3">
        <div class="info-box shadow-xs mb-0 h-100 bg-body">
          ...
          <div class="info-box-content">
            <span class="info-box-text text-secondary">RESERVED &amp; ALOKASI</span>
            <span class="info-box-number text-body fs-4 font-monospace">{{ totalReserved.toLocaleString('id-ID') }} <span class="fs-8 fw-normal text-secondary">Unit</span></span>
            <div class="progress" style="height: 2px;">
              <div class="progress-bar bg-warning" style="width: 45%"></div>
            </div>
            <span class="progress-description fs-9 text-secondary">Terkunci dalam Order</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-xl-3">
        <div class="info-box shadow-xs mb-0 h-100 bg-body">
          ...
          <div class="info-box-content">
            <span class="info-box-text text-secondary">STOK AVAILABLE</span>
            <span class="info-box-number text-success fs-4 font-monospace">{{ totalAvailable.toLocaleString('id-ID') }} <span class="fs-8 fw-normal text-secondary">Unit</span></span>
            <div class="progress" style="height: 2px;">
              <div class="progress-bar bg-success" style="width: 100%"></div>
            </div>
            <span class="progress-description fs-9 text-secondary">Bebas Dipesan Cabang</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-xl-3">
        <div class="info-box shadow-xs mb-0 h-100 bg-body">
          ...
          <div class="info-box-content">
            <span class="info-box-text text-secondary">TOTAL VALUASI ASET</span>
            <span class="info-box-number text-body fs-4 font-monospace">Rp {{ (totalValuation / 1000000).toFixed(1) }}<span class="fs-7 fw-normal">M</span></span>
            <div class="progress" style="height: 2px;">
              <div class="progress-bar bg-info" style="width: 80%"></div>
            </div>
            <span class="progress-description fs-9 text-secondary">Metode Moving Average</span>
          </div>
        </div>
      </div>
    </div>
