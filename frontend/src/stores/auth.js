...
export const useAuthStore = defineStore('auth', {
  ...
  getters: {
    ...
    isRegionalUser: (state) => state.user?.role === 'REGIONAL_MONITOR',
    regionId: (state) => state.user?.regionId || null,
    regionName: (state) => state.user?.regionName || null,
    regionCode: (state) => state.user?.regionCode || null,
